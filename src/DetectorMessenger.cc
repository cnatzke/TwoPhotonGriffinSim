   ...
   :fDetector(Det)
{
   ...
   fAddApparatusXRayAbsorbersCmd = new G4UIcmdWithAnInteger("/DetSys/app/addXRayAbsorbers",this);
   fAddApparatusXRayAbsorbersCmd->SetGuidance("Add TaSnCu X-Ray absorbers to clover faces");
   fAddApparatusXRayAbsorbersCmd->AvailableForStates(G4State_PreInit,G4State_Idle);
   // end CRN
...
{	
   ...
   delete fAddApparatusXRayAbsorbersCmd;
   //end CRN
...
void DetectorMessenger::SetNewValue(G4UIcommand* command,G4String newValue)
{
   ...
   if(command == fAddApparatusXRayAbsorbersCmd) {
      fDetector->AddApparatusXRayAbsorbers(fAddApparatusXRayAbsorbersCmd->GetNewIntValue(newValue));
   }
   // end CRN 
